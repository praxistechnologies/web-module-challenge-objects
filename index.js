...
createMenuItem('bean burrito', 8, 'Lunch')

createMenuItem('Soda', 2, 'Lunch')
...
//reviews.unshift({name: "Jack", rating: 5, feedback: "THE BEST OF THE BEST."});
//console.log(reviews)
...
Use the getLastReview function below to do the following:
  ...
  2. Return the last index as a string in the format: "{name} gave the restaurant a {rating} star review, and theirb feedback was: {feedback}"
